...
public class ManageTaskUI {
    ...
    public static final String TODAY_MENU_BAR = "//android.view.ViewGroup[@resource-id='com.todoist:id/list_container']//android.widget.TextView[@text='Today']";
    ...
    public static final String TASK_NAME_TEXTBOX_IN_EDIT_TASK = "//android.widget.EditText[@resource-id='com.todoist:id/item_content']";
